...
#define GYRO_MEASURES      				100.0 // Number of Gyro measures for calibration
#define ACC_MEASURES					100.0 // Number of Accel measures for calibration

static float GYRO_XOUT_OFFSET = 0;
static float GYRO_YOUT_OFFSET = 0;
static float GYRO_ZOUT_OFFSET = 0;
static float ACC_ZOUT_OFFSET = 0;
